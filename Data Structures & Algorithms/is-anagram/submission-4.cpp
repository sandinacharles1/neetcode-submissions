...
public:
    bool isAnagram(string s, string t) {
        ...
        //2. Create hashmap for char to frequencies so we can reference them
        unordered_map<char, int> Char_To_Freq_S;
        unordered_map<char, int> Char_To_Freq_T;
        //3. Loop through all the words and update thei respective frequency charts. the [] automatically defaults to 0
