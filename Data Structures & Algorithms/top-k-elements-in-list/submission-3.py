            ...
            if len(output) == k:
                ...
                if i in freq_to_num.keys():
                    for value in freq_to_num[i]: #If multiple values have same frequency
                        output.append(value)
        return output  #THIS WAS ADDED AFTER IT SAYS MY TEST CASES PASSED BUT I FAILED. I GUESS IT WANTS US TO STILL RETURN EVEN IF WE DONT HAVE THE EXACT AMOUNT WE WANT
